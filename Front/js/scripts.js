...
const info = [
    {
        imagen: 'url(/Front/picture/presentacion/minifixture1.png)',
    ...
    {
        imagen: 'url(/Front/picture/presentacion/minigrupo1.png)',
    ...
    {
        imagen: 'url(/Front/picture/presentacion/minicalendario1.png)',
    ...
    {
        imagen: 'url(/Front/picture/presentacion/Laeeb.jpg)',
    ...
    {
        imagen: 'url(/Front/picture/presentacion/AL-RIHLA.jpg)',
        titulo: 'AL RIHLA',
